...
import com.db.info.sql.haha.Gen_Sql_haha_Collect;
...
import com.entity.haha.AnnotationGetSQL4FutureBean;
import com.entity.haha.AnnotationSQLCommon4Bean;
import com.entity.haha.AnnotationUpdateSQL4FutureBean;
...
import com.entity.haha.*;
public class HahaCollectDAOBase {
	...
	public HahaCollectDAOBase(DBConInfo dbcGet, DBConInfo dbcSet)
	{
		this.dbcGet=dbcGet;
		this.dbcSet=dbcSet;
	}
	...
	private List<String> getUpdateSql(String[]dateArray) {//次日活跃率和活跃数，率需要先抽出历史上的n天前的那个数据
		...
		NewUserStatBean bean=new NewUserStatBean();
